...
@section('head.title','List Building Type')
                ...
                <div class="animated fadeIn">
                    <div class="card">
                        <div class="card-header">
                            <i class="fa fa-edit"></i> List Building Type
                            <div class="card-header-actions">
                                <a class="btn btn-block btn-outline-primary active" href="{{route('building_type.create')}}">
                                    New
                                </a>
                            </div>
                        </div>
                                            ...
                                            @foreach($buildingTypes as $index => $buildingType)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td class="text-center">
                                                        <a class="btn btn-info" href="{{route('building_type.update',['id' => $buildingType->id])}}">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        <a data-toggle="modal" class="btn btn-danger anchorClick"
                                                           data-url="{{route('building_type.delete',['id' => $buildingType->id]) }}"
                                                           data-name="{{$buildingType->type_name}}" href="#deleteModal">

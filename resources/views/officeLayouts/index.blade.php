...
@section('body.breadcrumb')
    {{ Breadcrumbs::render('office_layout') }}
@endsection
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-actions">
                                <a class="btn btn-block btn-outline-primary active" href="{{route('office_layout.create')}}">
                                    New
                                </a>
                            </div>
                        </div>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td class="text-center app-col-action">
                                                        ...
                                                        <a data-toggle="modal" class="btn btn-danger anchorClick"
                                                           data-url="{{route('office_layout.delete',['id' => $office->id]) }}"

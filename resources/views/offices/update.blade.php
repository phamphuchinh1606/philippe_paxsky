...
@section('head.title','Update Office Layout')
...
@section('body.breadcrumb')
    {{ Breadcrumbs::render('office.update',$office->office_name) }}
@endsection
        ...
        <div id="ui-view">
            <div>
                <div class="animated fadeIn">
                    <div class="row">
                        <div class="col-md-8">
                            <form method="post" id="form-building" action="{{route('office.update',['id' => $office->id])}}" enctype="multipart/form-data"
                                  id="form">
                                @csrf
